...
public class ErrandBoy
{
    ...
    static final float VELOCITY = 16.66f; // 50 / 3.
    ...
    public ErrandBoy(Bitmap picture)
    {
        ...
        moveDownCords[1] = new BitmapCoordinates(204,12,36,50);
        moveDownCords[2] = new BitmapCoordinates(15,11,35,50);
        moveDownCords[3] = new BitmapCoordinates(78,13,36,50);
        ...
        moveUpCords[1] = new BitmapCoordinates(206,201,36,50);
        moveUpCords[2] = new BitmapCoordinates(13,203,36,50);
        moveUpCords[3] = new BitmapCoordinates(76,205,36,50);
        moveUp = new BitmapAction(moveUpCords);

        BitmapCoordinates[] moveLeftCords = new BitmapCoordinates[4];
        moveLeftCords[0] = new BitmapCoordinates(144,75,36,50);
        moveLeftCords[1] = new BitmapCoordinates(207,75,36,50);
        moveLeftCords[2] = new BitmapCoordinates(16,75,36,50);
        moveLeftCords[3] = new BitmapCoordinates(79,74,36,50);
        ...
        moveRightCords[1] = new BitmapCoordinates(207,137,36,50);
        moveRightCords[2] = new BitmapCoordinates(13,139,36,50);
        moveRightCords[3] = new BitmapCoordinates(79,139,36,50);
        ...
        if (!movingState.equals(MovingStates.Still))
        {
            ...
            if (timeCount <= 0)
            {
                ...
                if (actionCounter >= 4)
                {
                    ...
                    velocityY = 0;
                    resetCounters();
                    currentBitmap = currentAction.getBitmap(0);
                    return;
