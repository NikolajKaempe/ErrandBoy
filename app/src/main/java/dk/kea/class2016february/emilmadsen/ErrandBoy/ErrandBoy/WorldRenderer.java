    ...
    public void render()
    {
        ...
        for (Car c : world.lane1){
            game.drawBitmap(cars,(int)c.x,(int)c.y,
                    c.currentBitmap.getSrcX(),c.currentBitmap.getSrcY(),
                    c.currentBitmap.getWidth(),c.currentBitmap.getHeight());
        }
        ...
        game.drawBitmap(world.errandBoy.picture,(int)world.errandBoy.x,(int)world.errandBoy.y,
                world.errandBoy.currentBitmap.getSrcX(),world.errandBoy.currentBitmap.getSrcY(),
                world.errandBoy.currentBitmap.getWidth(),world.errandBoy.currentBitmap.getHeight());
    }
}
